...
export default function Footer() {
  return (
    <footer className="bg-white py-8 px-4">
      <div className="px-6 mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        {/* Logo */}
        <div>
          <img src="logo.svg" alt="Aryan Gupta" className="w-10 h-10 object-contain" />
        </div>
        ...
        <ul className="flex items-center gap-6 text-sm">
          ...
          <li>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hover:text-pink-600 transition-colors underline underline-offset-2 decoration-pink-600 font-bold text-xl"
            >
