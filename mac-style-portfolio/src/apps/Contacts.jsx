    ...
    <Window
      ...
      children={
        <div className="bg-gray-900 w-full h-full rounded-b-lg flex">
          {/* Left Side */}
          <div className="hidden @3xl:block w-[38%] @5xl:w-[35%] flex-shrink-0 h-full bg-gray-800 border-r">
            <div className="p-3">
          ...
          <div className="flex-1 min-w-0 h-full flex flex-col">
            {/* Profile Section */}
            <div className="bg-gray-800 px-5 py-4 @2xl:px-8 @2xl:py-6 text-center border-b border-gray-700">
              <div className="w-14 h-14 @2xl:w-24 @2xl:h-24 bg-blue-500 rounded-full flex items-center justify-center text-xl @2xl:text-3xl font-bold text-white mx-auto mb-2 @2xl:mb-4">
                AG
              </div>
              <p className="text-lg @2xl:text-2xl font-bold text-white mb-1">Aryan Gupta</p>
              <div className="flex items-center justify-center gap-2">
                <HiOutlineAcademicCap className="text-gray-400 w-4 h-4 flex-shrink-0" />
                <p className="text-xs @2xl:text-sm text-gray-400">Computer Science Student at Northeastern University</p>
              </div>
            </div>

            {/* Contact Details */}
            <div className="px-5 py-4 @2xl:px-8 @2xl:py-6 flex-1 overflow-auto">
