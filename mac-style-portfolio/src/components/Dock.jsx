...
const Dock = () => {
  ...
  return (
    <div className="fixed bottom-2 w-full flex items-end justify-center">
        <div className='dock-shelf flex items-center justify-center max-w-[calc(100vw-1rem)] vibrancy rounded-xl shadow-lg'>
          {apps.map((app) => (
            <button key={app.name}
              className="dock-icon flex-shrink-0 flex items-center justify-center hover:scale-105 transition-transform"
